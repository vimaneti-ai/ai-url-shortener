...
export class ApiService {
  ...
  updateUrl(code: string, body: UpdateRequest): Observable<ShortenResponse> { return this.http.put<ShortenResponse>(`${this.baseUrl}/shorten/${encodeURIComponent(code)}`, body); }
  deleteUrl(code: string): Observable<void> { return this.http.delete<void>(`${this.baseUrl}/shorten/${encodeURIComponent(code)}`); }
}
